...
class AppOpenAdApiImpl @Inject constructor() : AppOpenAdApi {
    ...
    private fun adIsNotLoaded(cancellableContinuation: CancellableContinuation<Unit>) {
        try {
            throw com.animecraft.ad.api.AdException("The ad is not loaded", "", NOT_LOADED)
        } catch (adException: com.animecraft.ad.api.AdException) {
    ...
    private fun onAdFailed(
        ...
        try {
            throw com.animecraft.ad.api.AdException(loadError.message, loadError.domain, NOT_LOADED)
        } catch (adException: com.animecraft.ad.api.AdException) {
    ...
    private fun activityIsNull(cancellableContinuation: CancellableContinuation<Unit>) {
        try {
            throw com.animecraft.ad.api.AdException(
