...
package ua.animecraft.feature.rating.rate
...
import ua.animecraft.core.components.buttons.DontShowAgainButton
import ua.animecraft.core.components.buttons.FilledDialogButton
import ua.animecraft.core.components.buttons.OutlinedDialogButton
import ua.animecraft.feature.rating.Smile
...
private fun BottomRateDialogButtons(
    ...
    Column(modifier = modifier.fillMaxWidth()) {
        Row(
            ...
            ua.animecraft.core.components.buttons.OutlinedDialogButton(
                text = stringResource(R.string.not_now),
                modifier = Modifier
                    .height(AppTheme.sizes.dialogs.rate.buttonHeight)
                    .weight(1f),
                onClick = notNowClick
            )
        ...
        ua.animecraft.core.components.buttons.DontShowAgainButton(
    ...
    Row(
        ...
        smilesList.forEach { smile ->
            AnimatedContent(
                ...
                Image(
                    modifier = Modifier
                        .size(AppTheme.sizes.dialogs.rate.smileSize)
                        .clickable(
